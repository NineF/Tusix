...
public class ContextConfig implements LifecycleListener {
    ...
    public ContextConfig(){
        System.out.println("ContextConfig初始化");
    }
    /**
    ...
    protected void webConfig() {
        ...
        //此处解析的是catalina-home的web.xml
        System.out.println("此处解析默认的web.xml-->"+this.getClass());
        defaults.add(getDefaultWebXmlFragment());

        WebXml webXml = createWebXml();

        // Parse context level web.xml
        System.out.println("此处开始解析web.xml-->"+this.getClass());
     ...
     */
    //这里开始加载ServletContainerInitializer
    protected void processServletContainerInitializers(
            Set<WebXml> fragments) {

        System.out.println("此处加载ServletContainerInitializer-->"+this.getClass());
